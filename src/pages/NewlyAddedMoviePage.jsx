...
import '../pages/NewlyAddedMoviePage.css'
    ...
    return (
        movie ? (
            <section className='newlyAddedMovie_section'>
                <div className='movie_box py-4' style={{ backgroundImage: ` url(${movie?.mediaImage || movie?.mediaImageUrl})` }}>
                    <Container className='py-4 mt-4'>
                        <div className="movie_container">
                            <Row>
                                <Col lg={6} className='img_container'>
                                    <img src={movie?.mediaImage || movie?.mediaImageUrl} className='movie_img' />
                                </Col>
